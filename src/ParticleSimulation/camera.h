...
public:
	...
	void ProcessKeyboard(Camera_Movement direction, float deltaTime)
	{
		...
		if (direction == RIGHT)
			...
			Position += glm::vec3(0.01, 0.0, 0.0);
		if (direction == W) {
			Position += glm::vec3(Front.x * 100.1, Front.y * 100.1, Front.z * 100.1);
		}
...
private:
	...
	{
		//std::cout << "x dot = " << glm::dot(Front, glm::vec3(1.0, 0.0, 0.0)) << std::endl;
